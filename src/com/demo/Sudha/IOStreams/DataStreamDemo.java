...
public class DataStreamDemo {
	public static void main(String[] args) {
		String Filepath = "Sudha/samplefile.dat";
...
try (DataOutputStream dataOutputStream = new DataOutputStream(new FileOutputStream(filepath))) { 
			...
			dataOutputStream.writeUTF("Sudha");
			dataOutputStream.writeLong(123456789);
			dataOutputStream.writeDouble(45000.00);
			dataOutputStream.writeUTF("techs");
			dataOutputStream.writeUTF("Male");
